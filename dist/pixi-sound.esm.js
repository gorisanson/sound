 ...
 * Compiled Tue, 22 Mar 2022 10:07:30 UTC
 *
...
var WebAudioContext = (function (_super) {
    ...
    function WebAudioContext() {
        ...
        _this._ctx = ctx;
        _this._offlineCtx = new WebAudioContext.OfflineAudioContext(1, 2, ((win.OfflineAudioContext) && (8000 <= ctx.sampleRate && ctx.sampleRate <= 96000))
...
var SoundLoader = (function () {
    ...
    Object.defineProperty(SoundLoader, "legacy", {
        set: function (legacy) {
            var exts = extensions;
            if (!legacy) {
